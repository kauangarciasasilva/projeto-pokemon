...
import PokemonAbilityEntity from "../../pokemon-list/model/services/pokemon-ability-entity";
import PokemonEntity from "../../pokemon-list/model/services/pokemon-entity";
import PokemonLocationEntity from "../../pokemon-list/model/services/pokemon-location-entity";
import PokemonTypeEntity from "../../pokemon-list/model/services/pokemon-type-entity";

import React from "react";
import { Link } from "react-router-dom";
import { Container, PokemonStyle } from "./style";

export default function PokemonComponents (props:any){
